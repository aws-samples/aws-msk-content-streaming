...
export class ListArticles extends jspb.Message {
  ...
  static toObject(includeInstance: boolean, msg: ListArticles): ListArticles.AsObject;
  static serializeBinaryToWriter(message: ListArticles, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ListArticles;
  static deserializeBinaryFromReader(message: ListArticles, reader: jspb.BinaryReader): ListArticles;
}
