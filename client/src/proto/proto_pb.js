...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.proto.ListArticles.Request.displayName =
...
proto.proto.ListArticles.Response = function(opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.proto.ListArticles.Response.repeatedFields_,
    null
  );
};
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.proto.ListArticles.Response.displayName =
...
proto.proto.Item.prototype.getItemCase = function() {
  return /** @type {proto.proto.Item.ItemCase} */ (jspb.Message.computeOneofCase(
    this,
    proto.proto.Item.oneofGroups_[0]
  ));
};
  ...
  proto.proto.Item.toObject = function(includeInstance, msg) {
    var f,
      obj = {
        article:
          (f = msg.getArticle()) &&
          proto.proto.Article.toObject(includeInstance, f),
        image:
          (f = msg.getImage()) && proto.proto.Image.toObject(includeInstance, f)
      };
  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      case 10:
        ...
        reader.readMessage(
          value,
          proto.proto.Article.deserializeBinaryFromReader
        );
      ...
      case 11:
        ...
        reader.readMessage(
          value,
          proto.proto.Image.deserializeBinaryFromReader
        );
        msg.setImage(value);
        break;
      default:
...
proto.proto.Item.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(10, f, proto.proto.Article.serializeBinaryToWriter);
  }
  f = message.getImage();
  if (f != null) {
    writer.writeMessage(11, f, proto.proto.Image.serializeBinaryToWriter);
  }
};
...
proto.proto.Item.prototype.getArticle = function() {
  return /** @type{?proto.proto.Article} */ (jspb.Message.getWrapperField(
    this,
    proto.proto.Article,
    10
  ));
...
proto.proto.Item.prototype.getImage = function() {
  return /** @type{?proto.proto.Image} */ (jspb.Message.getWrapperField(
    this,
    proto.proto.Image,
    11
  ));
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.proto.Insert.Request.prototype.toObject = function(
    opt_includeInstance
  ) {
  ...
  proto.proto.Insert.Request.toObject = function(includeInstance, msg) {
    var f,
      obj = {
        item:
          (f = msg.getItem()) && proto.proto.Item.toObject(includeInstance, f)
      };
...
proto.proto.Insert.Request.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getItem();
  if (f != null) {
    writer.writeMessage(1, f, proto.proto.Item.serializeBinaryToWriter);
  }
};
...
proto.proto.Insert.Request.prototype.getItem = function() {
  return /** @type{?proto.proto.Item} */ (jspb.Message.getWrapperField(
    this,
    proto.proto.Item,
    1
  ));
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.proto.Insert.Response.prototype.toObject = function(
    opt_includeInstance
  ) {
 ...
 * @return {!proto.proto.Insert.Response}
 */
proto.proto.Insert.Response.deserializeBinaryFromReader = function(
  msg,
  reader
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.Insert.Response.serializeBinaryToWriter = function(
  message,
  writer
) {
  var f = undefined;
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.proto.Update.Request.prototype.toObject = function(
    opt_includeInstance
  ) {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.proto.Update.Response.prototype.toObject = function(
    opt_includeInstance
  ) {
 ...
 * @return {!proto.proto.Update.Response}
 */
proto.proto.Update.Response.deserializeBinaryFromReader = function(
  msg,
  reader
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.Update.Response.serializeBinaryToWriter = function(
  message,
  writer
) {
  var f = undefined;
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.proto.ListArticles.Request.prototype.toObject = function(
    opt_includeInstance
  ) {
...
proto.proto.ListArticles.Request.deserializeBinary = function(bytes) {
  ...
  return proto.proto.ListArticles.Request.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.proto.ListArticles.Request}
 */
proto.proto.ListArticles.Request.deserializeBinaryFromReader = function(
  msg,
  reader
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.ListArticles.Request.serializeBinaryToWriter = function(
  message,
  writer
) {
  var f = undefined;
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.proto.ListArticles.Response.prototype.toObject = function(
    opt_includeInstance
  ) {
    return proto.proto.ListArticles.Response.toObject(
      opt_includeInstance,
      this
    );
  };
...
proto.proto.ListArticles.Response.deserializeBinary = function(bytes) {
  ...
  return proto.proto.ListArticles.Response.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.proto.ListArticles.Response}
 */
proto.proto.ListArticles.Response.deserializeBinaryFromReader = function(
  msg,
  reader
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.ListArticles.Response.serializeBinaryToWriter = function(
  message,
  writer
) {
  var f = undefined;
...
proto.proto.ListArticles.Response.prototype.getArticlesList = function() {
  return /** @type{!Array<!proto.proto.Article>} */ (jspb.Message.getRepeatedWrapperField(
    this,
    proto.proto.Article,
    1
  ));
 ...
 * @return {!proto.proto.Article}
 */
proto.proto.ListArticles.Response.prototype.addArticles = function(
  opt_value,
  opt_index
) {
